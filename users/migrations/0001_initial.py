    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_street', models.CharField(blank=True, max_length=100, verbose_name='street')),
                ('delivery_house', models.CharField(blank=True, max_length=20, verbose_name='house')),
                ('delivery_apartment', models.CharField(blank=True, max_length=20, verbose_name='apartment')),
